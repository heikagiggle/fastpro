...
const AdminSidebar = () => {
  ...
  const mainMenuItems: NavItem[] = useMemo(
    () => [
      { url: '/admin/dashboard/', Logo: DashboardIcon, label: 'Dashboard' },
      {
        url: '/admin/dashboard/rfp-management/',
        Logo: CubeIcon,
        label: 'RFP Management',
      },
      { url: '/admin/dashboard/drafts/', Logo: CubeIcon, label: 'Drafts' },
      { url: '/admin/dashboard/projects/', Logo: CubeIcon, label: 'Projects' },
      {
        url: '/admin/dashboard/account-payable/',
        Logo: PaymentIcon,
        label: 'Account Payable',
      },
      { url: '/admin/dashboard/payments/', Logo: MoneyIcon, label: 'Payments' },
      {
        url: '/admin/dashboard/virtual-accounts/',
        Logo: MoneyIcon,
        label: 'Virtual Accounts',
      },
      { url: '/admin/dashboard/reports/', Logo: ReportIcon, label: 'Reports' },
    ],
    []
  );
